...
public class PagamentoService {
    ...
    public Pagamento registrarPagamentos(int reservaID, double valorPago, Pagamento.MetodoPagamento metodo) throws PagamentoInvalido,ReservaInvalida{
        Reserva reserva = reservaDao.buscarPorId(reservaID);

        if (reserva == null){
            throw new ReservaInvalida("ID não encontrado.");
        }
        ...
        if (valorPago < valorReserva) {
            throw new PagamentoInvalido("Valor pago é menor que o valor da reserva.");
        }
    ...
    public List<Pagamento> listarPagamentos() throws PagamentoInvalido{
